...
class HoverBug(Bug):
    def __init__(self, transform:Transform2D, animations:list, damage_size:float, max_hp:float, points:int, jitter:float, max_move_dist:float, idle_time:Vector2, speed:float, anim_speed:float = 1.0):
